...
export const findAddress: (_1:business) => list<string> = function _(Arg1) { const result = RecordsBS.findAddress([Arg1.name, ([Arg1.owner == null ? undefined : Arg1.owner.name, Arg1.owner == null ? undefined : Arg1.owner.age, (Arg1.owner == null ? undefined : Arg1.owner.address == null ? undefined : Arg1.owner == null ? undefined : Arg1.owner.address)]), (Arg1.address == null ? undefined : Arg1.address)]); return result };
export const findAllAddresses: (_1:business[]) => string[] = function _(Arg1) { const result = RecordsBS.findAllAddresses(Arg1.map(function _element(x) { return [x.name, ([x.owner == null ? undefined : x.owner.name, x.owner == null ? undefined : x.owner.age, (x.owner == null ? undefined : x.owner.address == null ? undefined : x.owner == null ? undefined : x.owner.address)]), (x.address == null ? undefined : x.address)]})); return result };